...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    if(!using_cl)
    {
      ...
      {
        ctx.stdout_behavior = bp::capture_stream();
        args = boost::assign::list_of("c++filt");
    ...
    else
    {
      ...
      ctx.stdout_behavior = bp::capture_stream();
      args = boost::assign::list_of("findstr")("UNDEF.*external_kernel");
    ...
    while(std::getline(is, line))
    {
      ...
      if(parse_symbol(using_cl, debug, line, symbol))
      {
        ...
        // configure
        args = boost::assign::list_of("cmake")(".");
        if(generator)
        {
          args.push_back("-G");
        ...
        // build
        args = boost::assign::list_of("cmake")("--build")(".");
